...
const CLOUD_NAME = "dup39fo44" // Tên cloud của bạn
const UPLOAD_PRESET = "ml_default";  // Upload preset
const CLOUDINARY_API_KEY = "337475483397382";  // API key
const CLOUDINARY_API_SECRET = "FyDYpODh0kyeR4beEPBO9I83XoE";  // API secret
